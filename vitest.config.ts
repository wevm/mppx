...
const alias = {
  ...
  'mppx/radius': path.resolve(import.meta.dirname, 'src/radius'),
  'mppx/radius/client': path.resolve(import.meta.dirname, 'src/radius/client'),
  'mppx/radius/server': path.resolve(import.meta.dirname, 'src/radius/server'),
