    ...
    request: z.pipe(
      z
        .object({
          ...
          recipient: z.optional(z.string()),
          settlementAdapter: z.optional(z.address()),
          settlementRouteSalt: z.optional(z.hash()),
          settlementTargetToken: z.optional(z.address()),
      ...
      z.transform(
        ({
          ...
          methodDetails: {
            ...
            ...(settlementAdapter !== undefined && { settlementAdapter }),
            ...(settlementRouteSalt !== undefined && { settlementRouteSalt }),
            ...(settlementTargetToken !== undefined && { settlementTargetToken }),
