...
export const classNames = {
  ...
  method: 'mppx-method',
  methodOverlay: 'mppx-method--overlay',
  statePane: 'mppx-state-pane',
  statePaneOverlay: 'mppx-state-pane mppx-state-pane--overlay',
  statePaneError: 'mppx-state-pane mppx-state-pane--error',
  statePaneSuccess: 'mppx-state-pane mppx-state-pane--success',
  status: 'mppx-status',
